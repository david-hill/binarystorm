...
sudo dnf -y install spamassassin amavis vim fail2ban git bind bind-utils net-snmp uptimed pyzor httpd tcp_wrappers yum mod_ssl roundcubemail.noarch whois net-snmp-utils
